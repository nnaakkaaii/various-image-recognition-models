...
class BaseOption:
    ...
    def initialize(self, parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
        ...
        parser.add_argument('--in_size', type=int, default=256, choices=[28, 128, 256], help='入力画像の大きさ')
        parser.add_argument('--in_nch', type=int, default=1, help='# of input image channels: 3 for RGB and 1 for grayscale')
